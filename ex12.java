...
class Word1 { // 영어 단어와 한글 단어를 쌍으로 가진 하나의 단어 표현
    private String english; // 영어 단어
    private String korean; // 영어 단어에 해당하는 한글 단어
    public Word1(String english, String korean) {
...
public class ex12 {
    ...
    public ex12(String name) {
        ...
        v.add(new Word1("emotion", "감정"));
        v.add(new Word1("human", "인간"));
        v.add(new Word1("stock", "주식"));
        v.add(new Word1("trade", "거래"));
        v.add(new Word1("society", "사회"));
        v.add(new Word1("baby", "아기"));
        v.add(new Word1("honey", "애인"));
        v.add(new Word1("dall", "인형"));
        v.add(new Word1("bear", "곰"));
        v.add(new Word1("picture", "사진"));
        v.add(new Word1("painting", "그림"));
        v.add(new Word1("fault", "오류"));
        v.add(new Word1("example", "보기"));
        v.add(new Word1("eye", "눈"));
        v.add(new Word1("statue", "조각상"));
    }
    ...
    private void insertWords() {
        ...
        while(true) {
            ...
            v.add(new Word1(engWord, korWord));
        }
    }
